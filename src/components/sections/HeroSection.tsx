      ...
      <div className="relative z-10 container mx-auto px-4 pt-32 pb-20">
        ...
        >
          <motion.span
            ...
            className="inline-block px-4 py-2 bg-foreground/10 backdrop-blur-sm rounded-full text-foreground text-sm font-medium mb-6"
          >
          ...
          >
            Discover Your Next
            <span className="block text-primary">Dream Destination</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
